...
class HomePage extends Page {
  ...
  async openLaunchWithPosition(position) {
    // await this.launchesLinks.baseCollection[0].waitForClickable({
    //   timeout: 15000,
    // });
    await this.launchesLinks.baseCollection[position - 1].click();
  }
}
